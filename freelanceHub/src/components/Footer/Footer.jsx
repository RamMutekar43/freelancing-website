...
export default function Footer() {
  return (
      <VStack backgroundColor={'black'} color={'gray.300'} py={10} w={'full'} px={10}>
      <div className=" w-full mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <ul className="space-y-3">
              <li>
                ...
                <div className="flex gap-3 mt-1 text-lg">
                  <a href="https://www.linkedin.com/in/ram-mutekar-4b6a49256/" target="_blank"><FaLinkedin /></a>
                  <a href="https://github.com/RamMutekar43" target="_blank"><FaGithub /></a>
                </div>
              </li>
              <li>
                <p className="font-medium text-white">Akshay Khardekar</p>
                <div className="flex gap-3 mt-1 text-lg">
                  <a href="https://www.linkedin.com/in/akshay-khardekar-65a303257/" target="_blank"><FaLinkedin /></a>
                  <a href="https://github.com/akshayKhardekar10" target="_blank"><FaGithub /></a>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm">Email: <a href="mailto:support@freelancehub.com" className="hover:text-white">support@freelancehub.com</a></p>
